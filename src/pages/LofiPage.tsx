            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-6">
                <GlitchText intensity="medium">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl mb-2 text-[#E86A2A]">CONTEMPLATIONS</h2>
                </GlitchText>
              ...
              <div className="rounded-lg overflow-hidden border-2 border-[#E86A2A]/30">
                <iframe
                  ...
                  frameBorder="no"
                  allow="autoplay"
                  src="https://w.soundcloud.com/player/?url=https%3A//soundcloud.com/artfalls/sets/contemplations&color=%23e86a2a&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false"
                  className="w-full"
                />
              </div>
            </div>
