...
export default function GlitchpopPage() {
  ...
  const tracks = [
    { title: 'MACHIAVELLI', url: 'https://soundcloud.com/artfalls/machiavelli' },
    { title: 'CRASH SALE', url: 'https://soundcloud.com/artfalls/crash-sale' },
    { title: 'ANXIETY', url: 'https://soundcloud.com/artfalls/anxiety' },
    { title: 'GHOST', url: 'https://soundcloud.com/artfalls/ghost' },
  ];
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16 max-w-6xl mx-auto">
          {tracks.map((track, index) => (
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 border-2 border-cyan-500 opacity-0 pointer-events-none rounded-lg"
                animate={{
                  opacity: [0, 0.5, 0],
                }}
                transition={{
